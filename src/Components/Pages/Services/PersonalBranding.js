...
import TrainerImage from '../../../Assets/solang.png'
    ...
    <div className='trainers-services trainers'>
        ...
        <div className='trainers-container'>
            ...
            <div className='trainer-desc'>
                <p>Solange El Rassi, an experienced Career Success Coach and media expert, guides executives in personal branding and career advancement. She emphasizes storytelling in digital spaces and has a 17-year background in media, including television. Involved in corporate social responsibility and youth empowerment, Solange holds a master's in media and advises top Middle Eastern brands. She is committed to creating impactful narratives and driving positive change.</p>

...
const Podcast = () => {
	...
	const youWillGetList = [
		{icon: WorkshopFeatureImageIcon, desc: 'فهم أهمية وطريقة تصميم الهوية البصرية، وتصميم غلاف البودكاست والحلقات'},
		{
			icon: WorkshopFeatureImageIcon,
			desc: 'تحرير وتحسين جودة الصوت وتعزيز السرد القصصي من خلال التصميم الصوتي، مع تجربة عملية.'
		},
		{icon: WorkshopFeatureImageIcon, desc: 'تطوير القدرة على التخطيط وكتابة وهيكلة حلقات بودكاست ممتعة.'},
		{icon: WorkshopFeatureImageIcon, desc: 'القدرة على تسجيل الصوت، وإجراء المقابلات، وسرد المحتوى بفعالية.'},
		{
			icon: WorkshopFeatureImageIcon,
								...
								<div className="input-wrapper">
									<label id="terms-label"><input type='checkbox' required/>
										<span>أنا أوافق على <a
											href='https://www.alaan.net/terms/'>الشروط و الأحكام</a> </span></label>
								</div>
								<div className="input-wrapper">

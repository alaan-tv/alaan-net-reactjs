...
const Media = () => {
	...
	const howItWorkList = [
		{desc: "تدرب على أهمّ أسس تقديم الأخبار والبرامج التلفزيونية لكل لصحافيين المبتدئين الراغبين بتطوير مهاراتهم و لكل الباحثين عن فرص عمل جديدة في عالم الإعلام"},
